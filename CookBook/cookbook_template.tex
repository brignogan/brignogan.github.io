...
\section*{Les icones dans les Recettes}
La signification des icones apparaissant dans les recettes est la suivante:

\begin{tabular}{ l l }
\setbox0=\hbox{\includegraphics[scale=0.04, trim= 0em -5em -5em -5em,]{temps_preparation_orange.pdf}} \parbox{\wd0}{\box0}  
	& temps de pr\'eparation  \\ 
\setbox0=\hbox{\includegraphics[scale=0.04, trim= 0em -5em -5em -5em,]{temps_cuisson_orange.pdf}} \parbox{\wd0}{\box0}  
	& temps de cuisson  \\ 
\setbox0=\hbox{\includegraphics[scale=0.04, trim= 0em -5em -5em -5em,]{temps_repos_orange.pdf}} \parbox{\wd0}{\box0}  
	& temps de repos  \\ 
\setbox0=\hbox{\includegraphics[scale=0.04, trim= 0em -5em -5em -5em,]{people_281x281_orange.pdf}} \parbox{\wd0}{\box0}  
	& nombre de service  \\ 
\end{tabular}
...
\thumbsoverview{Table des Marques de Couleurs}
